...
<div class="heading">
   <h3>Wishlist</h3>
   <p> <a href="home.php">Home</a> / Whishlist </p>
</div>
<section class="wishlist">
   ...
   <form action="" method="POST" class="box">
      ...
      <a href="wishlist.php?delete=<?= $fetch_wishlist['id']; ?>" class="delete-btn" onclick="return confirm('delete this from wishlist?');">Delete</a>
   </form>
   <?php
